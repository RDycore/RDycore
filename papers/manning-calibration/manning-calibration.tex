...
\begin{enumerate}
  \item \textbf{How far can the NLCD Manning lookup be wrong, in
        ...
        text describes is what we intend; calibrations under it, at
        $\pm 15\%$ and $\pm 30\%$ for fifteen classes and for three, are
        running as this is written and will replace this paragraph.
