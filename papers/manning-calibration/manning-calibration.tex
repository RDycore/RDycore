...
calibration confined to those stays physical. We report the prior
...
\label{tab:ladder}
\end{table}
% [PENDING o62: add the 3-class rows at sigma_alpha = 0.30 and 0.50 to tab:ladder -- the headline rows]
