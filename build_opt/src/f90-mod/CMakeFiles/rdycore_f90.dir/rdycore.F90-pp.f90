...
# 1 "/Users/wsugiarta/Documents/github/petsc/arch-opt/include/petsc/finclude/petscis.h" 1
# 6 "/Users/wsugiarta/Documents/github/petsc/arch-opt/include/petsc/finclude/petscsection.h" 2
...
module rdycore
  ...
  public :: RDyDouble, RDy, RDyGetVersion, RDyGetBuildConfiguration, RDyInit, RDyFinalize, &
            ...
            RDyGetOwnedCellHeights, RDyGetOwnedCellXMomenta, RDyGetOwnedCellYMomenta, &
  ...
  interface
    integer(c_int) function rdygetversion_(major, minor, patch, release) bind(c, name="RDyGetVersion")
      use iso_c_binding
      integer(kind=C_INT32_T),  intent(out) :: major, minor, patch
      logical(kind=C_BOOL), intent(out) :: release
    end function
    ...
    integer(c_int) function rdymmscomputesolution_(rdy, time, soln) bind(c, name="RDyMMSComputeSolution")
      ...
      integer(kind=C_INT64_T), value, intent(in) :: soln
    end function
    ...
    integer(c_int) function rdymmscomputeerrornorms_(rdy, time, l1_norms, l2_norms, linf_norms, &
      ...
      integer(kind=C_INT32_T),              intent(out) :: num_global_cells
    ...
    integer(c_int) function rdymmsestimateconvergencerates_(rdy, num_refinements, l1_rates, l2_rates, linf_rates) &
      ...
      use iso_c_binding
      type(c_ptr), value, intent(in)  :: rdy
      integer(kind=C_INT32_T),    value, intent(in)  :: num_refinements
    ...
    integer(c_int) function RDySetFlowDirichletBoundaryValues_(rdy, boundary_id, num_edges, ndof, bc_values) bind(c, name="RDySetFlowDirichletBoundaryValues")
      ...
      type(c_ptr), value, intent(in)  :: rdy
      integer(kind=C_INT32_T),    value, intent(in)  :: boundary_id
      integer(kind=C_INT32_T),    value, intent(in)  :: num_edges
      integer(kind=C_INT32_T),    value, intent(in)  :: ndof
    ...
    integer(c_int) function rdygetboundaryconditionflowtype_(rdy, boundary_id, bnd_cond_type) bind(c, name="RDyGetBoundaryConditionFlowType")
      ...
      type(c_ptr),    value, intent(in)  :: rdy
      integer(kind=C_INT32_T), value, intent(in)  :: boundary_id
      integer(kind=C_INT32_T),        intent(out) :: bnd_cond_type
    end function
    ...
    integer(c_int) function rdygetstep_(rdy, step) bind(c, name="RDyGetStep")
      use iso_c_binding
      type(c_ptr), value, intent(in)  :: rdy
      integer(kind=C_INT32_T),           intent(out) :: step
    end function
    ...
    integer(c_int) function rdygetlocalcellheights_(rdy, size, h) bind(c, name="RDyGetOwnedCellHeights")
      use iso_c_binding
      type(c_ptr), value, intent(in) :: rdy
    ...
    integer(c_int) function rdygetlocaclellxmomenta_(rdy, size, hu) bind(c, name="RDyGetOwnedCellXMomenta")
      use iso_c_binding
      type(c_ptr), value, intent(in) :: rdy
      integer(kind=C_INT32_T), value,    intent(in) :: size
    ...
    integer(c_int) function rdygetlocaclellymomenta_(rdy, size, hv) bind(c, name="RDyGetOwnedCellYMomenta")
      use iso_c_binding
      type(c_ptr), value, intent(in) :: rdy
      integer(kind=C_INT32_T), value,    intent(in) :: size
    ...
    integer(c_int) function rdygetlocalcellxcentroids_(rdy, size, values) bind(c, name="RDyGetOwnedCellXCentroids")
      use iso_c_binding
      type(c_ptr), value, intent(in) :: rdy
      integer(kind=C_INT32_T)   , value, intent(in) :: size
    ...
    integer(c_int) function rdygetlocalcellycentroids_(rdy, size, values) bind(c, name="RDyGetOwnedCellYCentroids")
      use iso_c_binding
      type(c_ptr), value, intent(in) :: rdy
      integer(kind=C_INT32_T)   , value, intent(in) :: size
      type(c_ptr), value, intent(in) :: values
    ...
    integer(c_int) function rdygetlocalcellzcentroids_(rdy, size, values) bind(c, name="RDyGetOwnedCellZCentroids")
      use iso_c_binding
      type(c_ptr), value, intent(in) :: rdy
      integer(kind=C_INT32_T)   , value, intent(in) :: size
      type(c_ptr), value, intent(in) :: values
    ...
    integer(c_int) function rdygetlocalcellareas_(rdy, size, values) bind(c, name="RDyGetOwnedCellAreas")
      use iso_c_binding
      type(c_ptr), value, intent(in) :: rdy
      integer(kind=C_INT32_T)   , value, intent(in) :: size
      type(c_ptr), value, intent(in) :: values
    ...
    integer(c_int) function rdygetlocalcellnaturalids_(rdy, size, values) bind(c, name="RDyGetOwnedCellNaturalIDs")
      use iso_c_binding
      type(c_ptr), value, intent(in) :: rdy
      integer(kind=C_INT32_T)   , value, intent(in) :: size
      type(c_ptr), value, intent(in) :: values
    ...
    integer(c_int) function rdygetboundaryedgexcentroids_(rdy, boundary_index, size, values) bind(c, name="RDyGetBoundaryEdgeXCentroids")
      use iso_c_binding
      type(c_ptr), value, intent(in) :: rdy
      integer(kind=C_INT32_T)   , value, intent(in) :: boundary_index
      integer(kind=C_INT32_T)   , value, intent(in) :: size
      type(c_ptr), value, intent(in) :: values
    end function
    ...
    integer(c_int) function rdysetregionalwatersource_(rdy, region_idx, size, watsrc) bind(c, name="RDySetRegionalWaterSource")
      use iso_c_binding
      type(c_ptr), value, intent(in) :: rdy
      integer(kind=C_INT32_T)   , value, intent(in) :: region_idx
      integer(kind=C_INT32_T)   , value, intent(in) :: size
      type(c_ptr), value, intent(in) :: watsrc
    end function
    ...
    integer(c_int) function rdysetinitialconditions_(rdy, ic) bind(c, name="RDySetInitialConditions")
      ...
      use petscvec
      type(c_ptr),      value, intent(in) :: rdy
      integer(kind=C_INT64_T), value, intent(in) :: ic
    end function
    ...
    integer(c_int) function rdycreateprognosticvec_(rdy, prog_vec) bind(c, name="RDyCreatePrognosticVec")
      ...
      use petscvec
      type(c_ptr), value, intent(in)  :: rdy
      integer(kind=C_INT64_T),   intent(out) :: prog_vec
    end function
    ...
    integer(c_int) function rdycreateonedofglobalvec_(rdy, global_vec) bind(c, name="RDyCreateOneDOFGlobalVec")
      ...
      use petscvec
      type(c_ptr), value, intent(in)  :: rdy
      integer(kind=C_INT64_T),   intent(out) :: global_vec
    end function
    ...
    integer(c_int) function rdyreadonedoflocalvecfrombinaryfile_(rdy, filename, local_vec) bind(c, name="RDyReadOneDOFLocalVecFromBinaryFile")
      ...
      type(c_ptr), value, intent(in)  :: rdy
      type(c_ptr), value, intent(in)  :: filename
      integer(kind=C_INT64_T),   intent(out) :: local_vec
    end function
...
contains
  ...
  subroutine RDySetup(rdy_, ierr)
    ...
    integer,   intent(out)   :: ierr
    ierr = rdysetup_(rdy_%c_rdy);if (ierr .ne. 0) then;call PetscErrorF(ierr,538,"/Users/wsugiarta/Documents/github/RDycore/src/f90-mod/rdycore.F90");call MPIU_Abort(PETSC_COMM_SELF,ierr);endif
  end subroutine
  ...
  subroutine RDyMMSEstimateConvergenceRates(rdy_, num_refinements, &
    ...
    type(RDy),                intent(inout) :: rdy_
    integer(kind=C_INT32_T),                 intent(in)    :: num_refinements
  ...
  subroutine RDyGetNumBoundaryEdges(rdy_, boundary_id, num_edges, ierr)
    type(RDy), intent(inout) :: rdy_
    integer(kind=C_INT32_T),  intent(in)    :: boundary_id
    integer(kind=C_INT32_T),  intent(out)   :: num_edges
    integer,   intent(out)   :: ierr
  ...
  subroutine RDySetFlowDirichletBoundaryValues(rdy_, boundary_id, num_edges, ndof, bc_values, ierr)
    type(RDy),       intent(inout)       :: rdy_
    integer(kind=C_INT32_T),        intent(in)          :: boundary_id
    integer(kind=C_INT32_T),        intent(in)          :: num_edges
    integer(kind=C_INT32_T),        intent(in)          :: ndof
  ...
  subroutine RDyGetOwnedCellHeights(rdy_, size, h, ierr)
    type(RDy),       intent(inout)          :: rdy_
  ...
  subroutine RDyGetOwnedCellXMomenta(rdy_, size, hu, ierr)
    type(RDy),       intent(inout)          :: rdy_
    integer(kind=C_INT32_T),        intent(in)             :: size
  ...
  subroutine RDyGetOwnedCellYMomenta(rdy_, size, hv, ierr)
    type(RDy),       intent(inout)          :: rdy_
    integer(kind=C_INT32_T),        intent(in)             :: size
  ...
  subroutine RDyGetOwnedCellXCentroids(rdy_, size, values, ierr)
    type(RDy),       intent(inout)          :: rdy_
    integer(kind=C_INT32_T),        intent(in)             :: size
  ...
  subroutine RDyGetOwnedCellYCentroids(rdy_, size, values, ierr)
    type(RDy),       intent(inout)          :: rdy_
    integer(kind=C_INT32_T),        intent(in)             :: size
    real(RDyDouble), pointer, intent(inout) :: values(:)
    integer,         intent(out)            :: ierr
  ...
  subroutine RDyGetOwnedCellZCentroids(rdy_, size, values, ierr)
    type(RDy),       intent(inout)          :: rdy_
    integer(kind=C_INT32_T),        intent(in)             :: size
    real(RDyDouble), pointer, intent(inout) :: values(:)
    integer,         intent(out)            :: ierr
  ...
  subroutine RDyGetOwnedCellAreas(rdy_, size, values, ierr)
    type(RDy),       intent(inout)          :: rdy_
    integer(kind=C_INT32_T),        intent(in)             :: size
    real(RDyDouble), pointer, intent(inout) :: values(:)
    integer,         intent(out)            :: ierr
  ...
  subroutine RDyGetOwnedCellNaturalIDs(rdy_, size, values, ierr)
    type(RDy),       intent(inout)          :: rdy_
    integer(kind=C_INT32_T),        intent(in)             :: size
    integer(kind=C_INT32_T),        pointer, intent(inout) :: values(:)
    integer,         intent(out)            :: ierr
  ...
  subroutine RDyGetBoundaryEdgeXCentroids(rdy_, boundary_index, size, values, ierr)
    type(RDy),       intent(inout)          :: rdy_
    integer(kind=C_INT32_T),        intent(in)             :: boundary_index
    integer(kind=C_INT32_T),        intent(in)             :: size
    real(RDyDouble), pointer, intent(inout) :: values(:)
    integer,         intent(out)            :: ierr
  ...
  subroutine RDySetRegionalWaterSource(rdy_, region_idx, size, watsrc, ierr)
    type(RDy),       intent(inout)       :: rdy_
    integer(kind=C_INT32_T),        intent(in)          :: region_idx
    integer(kind=C_INT32_T),        intent(in)          :: size
    real(RDyDouble), pointer, intent(in) :: watsrc(:)
    integer,         intent(out)         :: ierr
