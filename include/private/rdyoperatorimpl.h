...
PETSC_INTERN PetscErrorCode CreatePetscFluxOperatorReconstructed(RDyConfig *, RDyMesh *, PetscInt, RDyBoundary *, RDyCondition *, Vec *, Vec *, OperatorDiagnostics *, PetscOperator *);
